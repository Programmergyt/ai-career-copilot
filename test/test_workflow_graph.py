# python -m pytest -sv test/test_workflow_graph.py
"""workflow/graph.py 图结构与路由测试（不调用 LLM）。"""

import pytest
from workflow.graph import build_graph, _route_after_planner, _route_after_jd, _route_after_content, _respond
...
class TestBuildGraph:
    ...
    def test_build_graph_has_expected_nodes(self):
        ...
        expected = {"planner", "jd_agent", "profile_agent", "content_agent", "render_agent", "respond"}
