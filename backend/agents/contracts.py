...
AGENT_CONTRACTS: dict[str, AgentContract] = {
    ...
    "gap_agent": AgentContract(
        ...
        supported_intents=_fs("upload_jd", "gap_analysis"),
    ...
    "question_answer_agent": AgentContract(
        ...
        allowed_writes=_fs("reply_message"),
        supported_intents=_fs("ask_question"),
        supported_actions=_fs("answer_question"),
        default_retryable=True,
    ),
}
